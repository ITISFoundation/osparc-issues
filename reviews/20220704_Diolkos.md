...
| 1   | support      | [#558] Fix duplicate feature for large studies                                                                                         | PC        | **In Progress** | 1'       |            |
...
| 8   | public-api   | [#621] API framework for iSolve                                                                                                        | PC        | **In Progress** | 2'       |            |
| 10  | s4l:web      | [#519] M1–12 Enhancements of the modeling/simulator/postpro service and framework                                                      | Mag/IP/CR | **In Progress** | 12'      |            |
| 11  | filesystem   | [#579] osparc-fs: Remote Mounts                                                                                                        |           | Paused          | 0'       |            |
| 12  | TI           | [#91] TI Planning                                                                                                                      | MaG/OM    | **In Progress** | 4'       |            |
...
| 16  |              | <blockquote>[#625] port annotation</blockquote>                                                                                        | PC        | **In Progress** | 2'       |            |
...
| 25  |              | <blockquote>[#509] M1–9 Cybersecurity and privacy</blockquote>                                                                         | DK        | **In Progress** | 2'       |            |
...
| 28  | portal       | [#545] Portal work                                                                                                                     | IP        | **In Progress** | 2'       |            |
...
| 30  | support      | [#232] Devops                                                                                                                          | ALL/DK    | **In Progress** | 4'       |            |
