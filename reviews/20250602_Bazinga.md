...
| --- | ------------------------------------------------------------------------------- | ----------------------- | --------------- | ----------------------- | ---------- |
| 1   | [#28] Job Submission from Desktop Application                                   | [MD], [PC], [MaG], [OM] | **In progress** | 3'[OM] 3'[MD] 3'[PC]           |            |
|     | <blockquote>[#1645] web API: extension to manage job queue (May) 🚩</blockquote>|                         | **In progress** |                         |            |
| 2   | [#7] oSPARC Sim4Life.Web Integration                                            | [OM]              | **In progress** | 8'[OM]                  |            |
...
| 6   | [#1652] Reducing Overhead Costs by Merging Deployments (Aug.) 🚩                | [MB], [GCR], [DK] | **In progress** | 2'[DK]                  |            |
...
| 10  | [#51] Enhanced Collaboration: Conversation Feature                              | [OM]              | **In progress** | 2'[OM]                  |            |
