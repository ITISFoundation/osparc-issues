...
| --- | ------------------------------------------------------------------------------- | ----------------------- | --------------- | ----------------------- | ---------- |
| 1   | [#28] Job Submission from Desktop Application                                   | [MD], [PC], [MaG], [OM] | **In progress** | 3'[OM] 3'[PC]           |            |
|     | <blockquote>[#1645] web API: extension to manage job queue (May) 🚩</blockquote>|                         | **In progress** |                         |            |
| 2   | [#7] oSPARC Sim4Life.Web Integration                                            | [MD], [OM]              | **In progress** | 8'[OM]                  |            |
| 3   | [#14] Meta-modeling: Refinements & FollowUps                                    | [MB], [JGO], [WVG]      | **In progress** | 4'[WVG]+2'[JGO]+2'[MB]  |            |
| 4   | [#78] Selection of Apps for V9 Release                                          | [MaG]                   | **In progress** | 1'                       |            |
| 5   | [#79] Analyse and improve platform stability                                    | [SAN]                   | **In progress** | 8'                      |            |
| 6   | [#1652] Reducing Overhead Costs by Merging Deployments (Aug.) 🚩                | [MB], [GCR], [MD], [DK] | **In progress** | 2'[DK]                  |            |
| 7   | [#3] AI tasks - Code Generation, Chat Bot                                       | [DK]                    | **In progress** | 8'[DK]                  |            |
...
|     | <blockquote>[#1636]  DevOps 🚩 </blockquote>                                    | [DK],[YH] [MB]          | **In progress** | 3'[DK]+2'[YH]+3'[MB]    |            |
| 15  | [#9] AWS Cost Optimization  🚩                                                  | [YH]                    | **In progress** | 2'[YH]                  |            |
| 16  | [#1597] NIH Year 8                                                              | [PC]                    | **In progress** | 2'[PC]                  |            |
...
| -------------------------------------------------------------------------------------------------- | ------------ | --------------- | -------- | ---------- |
| [#87] 214794: Contract Testing sim4life API                                                        |              | Paused          | O        |            |
...
| [#113] 198086: Keep installed python packages in project                                           | [MaG]        | **Resolve**     |          |            |
