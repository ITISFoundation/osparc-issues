# Review Meeting - August 14, 2023 @ XX:00 CET
...
|WP2|[#949] sim4life.io - WP2: Product|[DK]|**In Progress**| 2' |? |
||<blockquote> ZMT deployment (WP9)</blockquote>|[DK]|**In Progress**| 2'||
|WP3|[#922] sim4life.io - WP3: Tracking of resource usage|[OM], [SAN], [DK]|**In Progress**| - | '|
||<blockquote>[] Wallets</blockquote>|[OM]|**Done**||5'|
||<blockquote>[] Resource usage tracker</blockquote>|[SAN]|**In Progress**||3'|
...
||<blockquote>[#618] personalizable resource limits</blockquote>|[SAN]|**In Progress**||1'|
|WP5|[#951] sim4life.io - WP5: Dynamic services backend|[ANE],[SAN]|**In Progress**| - |6'|
||<blockquote>[#638] improving dynamic-sidecar design</blockquote>|[ANE]|**In Progress**| - ||
||<blockquote>[#618] personalizable resource limits</blockquote>|[SAN]|**In Progress**||0'|
|WP6|[#952] sim4life.io - WP6: API| [MB]|**In Progress**| - |2'|
|WP7|[#953] sim4life.io -  WP7: Platform improvements|[PC]|**In Progress**|||
||<blockquote>[#979] Project home page</blockquote>|[OM], [ANE], [MaG], [BL]  |**In Progress**| - |2'|
||<blockquote>[#980] Fast navigation between projects</blockquote>|[ANE]|**Todo**|||
|WP8|[#933] sim4life.io - WP8: s4l:web|[MaG], [IP]|**In Progress**| - |'|
||<blockquote>[#931] S4L Introduction Mode, Helpers/Tippies</blockquote>|[IP]|**In Progress**| - | 1'|
||<blockquote>[#881] basic monitoring functionality</blockquote>|[MaG]|**In Progress**| - |'|
||<blockquote>[#621] API framework for iSolve</blockquote>|[MaG]|**In Progress**| - |'|
||<blockquote>In-App Python Console</blockquote>|[IP]|**In Progress**| - |3'|
...
|WP9|[#933] sim4life.io - WP9: User Privacy|[DK]|**In Progress**| 1' |'|
||<blockquote>[] Encryption of data</blockquote>|[DK]|**Paused**| 1' ||
|TIP|[#831] TIP v2|[OM] |**In Progress**| - |2'|
...
|Y6-M8|[#697] M8 Attribute (& Charge) Resource Usage| [SAN]|**In Progress**| - |2'|
|Y6-NIH|[#694] M1-12 Proactive onboarding of services and models|[ANE]|**Ongoing**| - |'|[PC]|**Ongoing**| - |5'|
||<blockquote>[#674] M1-12 Portal development work </blockquote>|[IP]|**Ongoing**| - |'|
||<blockquote>[] Hackathon </blockquote>|[OM]?|**Ongoing**| - |'|
|Maintenance|[#675] M1-12 Maintenance and DevOps| [DK], [YH], [SAN], [ANE]|**Ongoing**| 3' |'|
|Z43|[#976] Z43 Energy Monitoring|[DK], [ALL]|**Ongoing**| 1' |'|
|Z43|[#1000] Sim4Life with Electron: proof of concept|[SCA]|**Paused**| 1' |'|
