...
| [#237] OpenFoam Plugin for Sim4Life                                                            | [SR]                                              | ![In Progress]              | 5'       |            |
...
| [#1639] Portal Development                                                                     | [APG], [MaG], [PC]                                | ![In Progress (Epics)]      | 1'       |            |
| [#214] Autoscaling of core osparc platform                                                     | [SAN]                                             | ![Planned]                  | 0        |            |
| [#238] AI chatbot in sim4life.io for user support                                              | [APG], [GCR], [MaG], [DK], [PC]                   | ![In Progress (Epics)]      | 3'       |            |
...
| [#1652] Reducing Overhead Costs by Merging Deployments (Aug. -> Feb) 🚩                        | [GCR], [DK], [PC]                                 | ![In Progress (Epics)]      |          |            |
| [#280] #SIM4-148 - New issue: Cannot set my phone number ...                                   | [OM], [PC]                                        | ![In Progress]              | 3'       |            |
...
| [#246] Working Group: Port Definitions                                                         | [PC], [WVG]                                       | ![Planned]                  |          |            |
...
| Title                                                                 | Presenter | Status | Duration | Start-Time |
| -----                                                                 | --------- | ------ | -------- | ---------- |
| 194317 Filter option for task manager (queued, running, failed...)    | --------- | ------ | -------- | ---------- |
| 209025 Missing Feature: Workbench                                     | --------- | ------ | -------- | ---------- |
| 222133 Bring Back Restart Button                                      | --------- | ------ | -------- | ---------- |
| 222581 Missing Feature: Table                                         | --------- | ------ | -------- | ---------- |
|                                                                       |           |        |          |            |
| 225060 Application stays Busy although it is not                      | --------- | Fixed  | -------- | ---------- |
| 223546 Only one simulation result downloads at a time                 | --------- | Fixed  | -------- | ---------- |
| 222953 Multi-tree does not remember the first selected item           | --------- | Fixed  | -------- | ---------- |
| 224527 Crash in ACIS when importing many STEP files                   | --------- | Fixed  | -------- | ---------- |
