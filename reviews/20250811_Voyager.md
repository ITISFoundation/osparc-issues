...
| [#238] AI chatbot in sim4life.io for user support                                              | [APG], [MaG], [DK]        | ![In Progress (Epics)]      | 3'       |            |
...
| [#1652] Reducing Overhead Costs by Merging Deployments (Aug. -> Feb) 🚩                        | [DK]                      | ![In Progress (Epics)]      | 1;       |            |
| [#280] #SIM4-148 - New issue: Cannot set my phone number ...                                   | [OM]                      | ![In Progress]              | 3'       |            |
...
| [#1328] Maintenance / Dev Issues                                                               | [SAN], [DK]               | ![In Progress (Epics)]      | 5'       |            |
| [#281] #SIM4-150 - Activity Center buttons in light theme                                      | [OM]                      | ![Resolved (ready to test)] | 1'       |            |
| [#9] AWS Cost Optimization for all deploys 🚩                                                  | [DK]                      | ![In Progress (Epics)]      | 3'       |            |
...
| Title                                                              | Presenter | Status                      | Duration      | Start-Time |
| ------------------------------------------------------------------ | --------- | --------------------------- | ------------- | ---------- |
| 194317 Filter option for task manager (queued, running, failed...) | [APG]     | ![Resolved]                 | Overall 10'   | ---------- |
