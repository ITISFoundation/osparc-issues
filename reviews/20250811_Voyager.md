...
| ---------------------------------------------------------------------------------------------- | ------------------------- | --------------------------- | -------- | ---------- |
| [#1647] Simultaneous access to a pipeline in view-only mode (Aug.) 🚩                          | [OM]                      | ![Resolved (ready to test)] | 6'       | 10:05     |
| [#303] Support center                                                                          | [OM]                      | ![Resolved (ready to test)] | 6'       | 10:11      |
| [#1905] Metamodeling: Functions browser                                                        | [OM]                      | ![Resolved (ready to test)] | 3'       | 10:17      |
| [#14] Metamodeling: Refinements & FollowUps                                                    | [WVG]                     | ![In Progress (Epics)]      | 3'       | 10:20      |
| [#240] Metamodeling: Persistency                                                               | [APG], [JGO]              | ![Resolved]                 | 0'       |            |
| [#243] Metamodeling: MOGA (Voyager)                                                            | [APG], [JGO]              | ![In Progress (Epics)]      | 3'       | 10:23      |
| [#237] OpenFoam Plugin for Sim4Life                                                            | [SyR]                     | ![In Progress]              | 5'       | 10:26      |
| [#21] Circuit Simulator                                                                        | [PC]                      | ![In Progress]              | 1'       | 10:31      |
| [#264] WG: Lazy Loading of Projects (Primarily Sim4Life)                                       | [MaG]                     | ![Resolved]                 | 3'       | 10:32      |
| [#23] PO center and metabase panel for app-team                                                | [SyR] [PC]                | ![Resolved (ready to test)] | 3'       | 10:35      |
| [#265] Fast Exploring of Projects Contents                                                     | [OM]                      | ![In Progress (Epics)]      | 0        |            |
| [#229] Job Submission & Activity center Follow Up                                              | [MB]                      | ![In Progress (Epics)]      | 1'       | 10:38      |
| [#1167] Stop button to get services out of the failed state. (Can probably be linked to #1045) | [ANE]                     | ![In Progress (Epics)]      | 3'       | 10:39      |
| [#15] Filesystem - Mounting remote resources (Dropbox, sftp, S3)                               | [ANE],                    | ![In Progress (Epics)]      | 1'       | 10:42      |
| [#1639] Portal Development                                                                     | [PC]                      | ![In Progress (Epics)]      | 3'       | 10:43      |
| [#214] Autoscaling of core osparc platform                                                     | [SAN]                     | ![Paused]                   | 0        |            |
| [#238] AI chatbot in sim4life.io for user support                                              | [APG], [MaG], [DK]        | ![In Progress (Epics)]      | 3'       | 10:46      |
| [#239] AI sim4life: text to code for simulation models                                         | [PC]                      | ![Planned]                  | 1'       | 10:49      |
| [#244] Help find templates                                                                     | [OM]                      | ![Resolved (ready to test)] | 1'       | 10:50      |
| [#247] Current maximum number of users able to run some services can be limited to <20 users   | [SAN]                     | ![In Progress]              | 3'       | 10:51      |
| [#242] Sim4Life UI changes to improve interface layering and visual cues for navigation.       | [APG], [MaG]              | ![Resolved (ready to test)] | 1'       | 10:54      |
| [#245] Working Group: plugin publication process                                               | [MaG]                     | ![Paused]                   |          |            |
| [#1652] Reducing Overhead Costs by Merging Deployments (Aug. -> Feb) 🚩                        | [DK]                      | ![In Progress (Epics)]      | 1'       | 10:55      |
| [#280] #SIM4-148 - New issue: Cannot set my phone number ...                                   | [OM]                      | ![In Progress]              | 3'       | 10:56      |
| [#236] Job Submission from desktop including project tags                                      | [MB], [MaG]               | ![Paused]                   |          |            |
| [#11] Share resources typing the email address                                                 | [PC]                      | ![In Progress (Epics)]      | 1'       | 10:59      |
| [#8] Performance Improvements for Large Projects                                               | [SAN]                     | ![Paused]                   | 0'       |            |
| [#10] Hardening the computational backend                                                      | [SAN]                     | ![Paused]                   | 0'       |            |
| [#47] Notification System for shared resources                                                 | [PC]                      | ![In Progress (Epics)]      | 3'       | 11:00      |
| [#1328] Maintenance / Dev Issues                                                               | [SAN], [DK]               | ![In Progress (Epics)]      | 5'       | 11:03      |
| [#281] #SIM4-150 - Activity Center buttons in light theme                                      | [OM]                      | ![Resolved (ready to test)] | 1'       | 11:08      |
| [#9] AWS Cost Optimization for all deploys 🚩                                                  | [DK]                      | ![In Progress (Epics)]      | 3'       | 11:09      |
| [#246] Working Group: Port Definitions                                                         | [PC]                      | ![Planned]                  | 0'       | 11:12      |
| [#16] Phasing out of tip.itis.swiss (End 2025)                                                 | [DK]                      | ![In Progress (Epics)]      | 0'       |            |
| [#17] Services listing can be grouped by tags                                                  |                           | ![Planned]                  |          |            |
...
| [#1968] PO Center for Admin                                                                    | [OM]                      | ![Resolved]                 | 1'       | 11:13      |
...
| Title                                                              | Presenter | Status                      | Duration      | Start-Time |
| ------------------------------------------------------------------ | --------- | --------------------------- | ------------- | ---------- |
| 194317 Filter option for task manager (queued, running, failed...) | [APG]     | ![Resolved]                 | Overall 10'   | 11:14      |
...
| 224421 File filters should be case insensitvie                     | [MaG]     | ![Resolved]                 |               | ---------- |
|                                                                    |           |                             |               |            |
...
| 222953 Multi-tree does not remember the first selected item        | [MaG]     | ![Resolved (ready to test)] |               | ---------- |
| 224527 Crash in ACIS when importing many STEP files                | [MaG]     | ![Resolved (ready to test)] |               | ---------- |
| 215816 Bug in show settings for a 2D plot when not visible         | [MaG]     | ![Resolved (ready to test)] |               | ---------- |
