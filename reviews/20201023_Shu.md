...
| [#16]</br>[#304] | o2S2PARC API, S-D12, Y3M5 </br>Prep2Go: creating features to support complex S4L scripts |            | In Progress                    | ? min    |            |
|                  | - solvers API*                                                                           | [PC]       |                                |          |            |
|                  | - S4L -> osparc automation                                                               | [ANE]      |                                |          |            |
|                  | - backend pipeline control enhancements                                                  | [SAN]      |                                |          |            |
...
| [#327]           | S-D8 o2S2PARC Guided Mode Y4M05                                                          | [KZ]       | In Progress                    | ?        |            |
| [#232]           | Team Black support: [TB-Backlog] 📊                                                    | [KZ]       | Ongoing                        | ? min    |            |
|                  | - Z43 support: [Z43-Backlog] 📊                                                        |            |                                |          |            |
| *                | Update on DevOps                                                                         | [ALL]      |                                | ? min    |            |
| *                | Platform stability [[#1426]]: [online]+[operational]+[performant]?                       | [PC] [SAN] |                                | ? min    |            |
