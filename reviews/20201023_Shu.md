...
| ---------------- | ---------------------------------------------------------------------------------------- | --------- | ------------------------------ | -------- | ---------- |
| [#344]           | J-D4.6. A computational Minimal Information Standard (cMIS) has been established Y4M03   | [PC]      | Ongoing                        | 5 min    |            |
| [#91]            | TI Treatment Planning                                                                    | [KZ]      | In Progress (**NEEDS TRIAGE**) | ?? min   |            |
| [#16]</br>[#304] | o2S2PARC API, S-D12, Y3M5 </br>Prep2Go: creating features to support complex S4L scripts | [PC]      | In Progress                    | ? min    |            |
| [#331]           | S-D25.1 Simulation Framework Functionality Y4M04                                         |           |                                |          |            |
| [#329]           | S-D23 Data Analysis and Derived Data Y4M06                                               |           |                                |          |            |
| [#26]            | Support onboarding of SPARC computational mode, [S-D1], Y3M1-12                          |           |                                |          |            |
| [#327]           | S-D8 o2S2PARC Guided Mode Y4M05                                                          |           |                                |          |            |
|                  | Update  on DevOps                                                                        | [ALL]     |                                | ? min    |            |
| [#232]           | Team Black support: [TB-Backlog] 📊                                                      | [KZ]      | Ongoing                        | ? min    |            |
|                  | Z43 support: [Z43-Backlog] 📊                                                            |           |                                |          |            |
|                  | Platform stability  [[#1426]]                                                            | [PC]      | Ongoing                        | ? min    |            |



<!--
| [#304] | Prep2Go: creating features to support complex S4L scripts  | [PC] |         |       |     |
| [----] | F--------------------------------------------------------6 | [--] | D-----e | 1---n | undefined- |
