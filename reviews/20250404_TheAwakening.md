...
|---------|-------------------------------------------------------|------------|-----------------|---------------------------|------------|
| [#1644] | API: Create Projects with Associated Data (Feb.)      | [MB] (PC)  | **In progress** | 3'                        |    10:05        |
| [#6]    | Feature to undo a delete - "recycle bin" style        | [PC]       | **Done**        | 1'                        |     10:08       |
| [#7]    | oSPARC Sim4Life.Web Integration                       | [OM]       | **In progress** | 0'                        |          |
| [#1635] | UI/UX for Data Handling (Feb.)                        | [OM]       | **In progress** | 3'                        |     10:09       |
| [#8]    | Performance Improvements for Large Projects           | [SAN]      | **Paused**      | 0'                        |            |
| [#28]   | Job Submission from Desktop Application               | [MaG]      | **In progress** | 2'                        |     10:12       |
| [#1652] | Reducing Overhead Costs by Merging Deployments (Aug.) | [DK]       | **In progress** | 2'                        |     10:14  |
| [#11]   | Share resources typing the email address              | [OM]       | **In progress** | 2'                        |     10:16  |
| [#1859] | Caching functionality for a function in TIP (SBO)     | [MEST]     | **In progress** | 1'                        |     10:18  |
| [#1328] | Maintenance / Dev Issues                              | [SAN] [OM] | **In progress** | 2'(SAN) + 3'(OM)          |     10:19  |
| [#9]    | AWS Cost Optimization                                 | [YH] /[DK] | **In progress** | 2'                        |     10:24  |
| [#10]   | Hardening the computational backend                   | [SAN]      | **In progress** | 2'                        |     10:26  |
| [#1639] | Portal Development                                    | [MaG]      | **In progress** | 1'                        |     10:28  |
| [#14]   | Meta-modeling: Refinements & FollowUps                | [WVG]      | **In progress** | 5'                        |     10:29  |
| [#1332] | NIH Year 7                                            | [MaG]      | **In progress** | 1'                        |     10:34  |
| [#1597] | NIH Year 8                                            | [MaG]      | **In progress** | 1'                         |     10:35  |
| [#1636] | DevOps                                                | [DK]/[YH]  | **In progress** | 6'                        |     10:36  |

## Part 2: Resolved cases

|           | Title                                                                   | Presenter | Status   | Duration | Start-Time |
|-----------|-------------------------------------------------------------------------|-----------|----------|----------|------------|
| [#190230] | Failing to start study (rephrase the error message)                     | [OM] [PC] | **Done** | 5'       |     10:42     |
...
| [#213265] | Request for GPU Upgrade and Persistent Module Installation on osparc.io | [SAN]     | **Done** | 2'       |     10:47  |

## Part 3: Sim4Life web service

|           | Title                                               | Presenter | Status          | Duration | Start-Time |
|-----------|-----------------------------------------------------|-----------|-----------------|----------|------------|
| [#216049] | Upgrade Toolchain from Ubuntu 20.04 to Ubuntu 24.04 | [MaG]     | **In progress** | 2'       |   10:49    |
| [#214794] | Contract Testing sim4life API                       | [MaG]     | **paused**      |      0'  |
| [#209150] | Missing Feature: Sensor Progress Report             | [MaG]     | **In progress** |      2'  |   10:51    |
| [#209198] | Sim4Life Simulator Plugin Framework                 | [MaG]     | **In progress** |      5'  |   10:53    |

## Part 4: Varia

|      | Title                          | Presenter | Status          | Duration  | Start-Time |
|------|--------------------------------|-----------|-----------------|-----------|------------|
| [#3] | AI Retreat Follow-Up - Chatbot | [PC][DK]  | **In progress** | 10' (PC)+ |   10:58    |
