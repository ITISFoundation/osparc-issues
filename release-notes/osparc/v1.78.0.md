...
##### Folders
Create folders and move Studies to the folders to help organizing your studies
##### Workspaces
These are collaboration hubs. All the studies and folders created or moved there will automatically shared with all the users that have access to the Workspace.
...
Ports with icons: downloading, uploading, completed
