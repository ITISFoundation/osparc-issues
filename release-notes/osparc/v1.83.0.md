...
- Templates split into meaningful sections:
  ...
  - Public Projects: These are templates shared with the entire oSPARC community — great for discovery and inspiration.
...
* ⚡ **Faster Port Assignments**: Improved performance when assigning compatible ports between nodes — now quicker and more efficient!
...
* 📈 **Expanded I/O Support**: Computational services can now handle more than 10 inputs/outputs — more flexibility for complex workflows!
...
* 📝 **Correct Study Naming**: Resolved an issue where stides appeared as `undefined-metadata` in the billing center — names now display correctly!
