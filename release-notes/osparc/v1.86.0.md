Click on the link for a list of all the PRs released since `v1.85.0`
...
<div align="center">
  <img width="800px" alt="image" src="https://github.com/user-attachments/assets/e42aa7b2-c9f6-475b-8cfa-34aff78a8adb" />
</div>

#### 💬 Prettified conversations
- Conversations are now easier to read thanks to improved formatting and spacing.
- Messages render with clearer separation, making it simpler to follow the flow of discussion.
- Inline elements (like code snippets, links, and lists) display with a more consistent style.
