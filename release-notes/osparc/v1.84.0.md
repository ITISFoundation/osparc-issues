...
- Functions Browser lets you:
  ...
  - View function details:
    - Overview: Owners can edit the title and description.
    - Pipeline view for detailed inspection.
...
The Projects tab search widget now supports filtering across:
- My Projects
- Templates
- Public Projects
...
- Added info tooltips next to potential collaborators to clarify permissions.
- In shared projects, you can now see the gravatar of the user currently editing the project.
