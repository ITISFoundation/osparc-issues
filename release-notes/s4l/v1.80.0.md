...
Sim4Life V8.4 now provides direct access online to all functionalized <a title="ViP" rel="noopener noreferrer" href="https://itis.swiss/virtual-population/" target="_blank">ViP models of the IT&rsquo;IS Foundation</a> and <a title="EM Phantoms" rel="noopener noreferrer" href="https://speag.swiss/products/em-phantoms/overview-2/" target="_blank">EM phantoms from SPEAG</a>. The Shop allows users to incorporate these gold-standard models into simulations directly via the web GUI, simplifying setup and improving recognition.

<div align="center">
  <img alt="TheShop" src="[https://github.com/user-attachments/assets/0362e723-cdc7-4c99-bfd1-0910c2204f36](https://github.com/user-attachments/assets/13b7a874-ceb5-424d-80b9-c6359fee51fa)" width="800px">
</div>
