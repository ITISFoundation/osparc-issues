...
- New service `s4l-framework` for plugin development and publishing in recently established sim4life plugin Marketplace
...
This platform release is packed with major upgrades designed to take your simulations to the next level. We’ve tackled long-standing requests and introduced powerful new features, including:
...
- The App Browser now includes even more Apps and they are categorized — go explore and see what new tools you can plug into your workflows!
...
- **Tutorials**, which are snapshots of Projects — reusable starting points you can build your own workflows from — have been expanded and reorganized into meaningful sections:
  - **Templates**: Found under the Projects tab, these include the templates you’ve created and those shared with you. Whenever you want to save a project’s state and branch off from it later, Templates are the perfect tool.
  - **Public Projects**: Also under the Projects tab, these are templates shared with the entire Sim4Life community — great for discovery and inspiration. Feel free to spread your work with the community, making it easier than ever to contribute and collaborate.
  - **Tutorials**: This section stays in the same place but the content was curated to help newcomers get started and help all users better understand the full potential of Sim4Life.
...
<div align="center">
  <img alt="Dashboard" src="https://github.com/user-attachments/assets/e15de077-69e1-4768-b49e-7c16d2dddaae" width="800px">
</div>
...
This change makes it easier than ever to scale up your projects and take full advantage of Sim4Life’s modular architecture.

<div align="center">
  <img alt="ConvertToPipeline" src="https://github.com/user-attachments/assets/bfb17b86-8575-4dd2-bc39-15dbf91dfe85" width="800px">
</div>
...
<div align="center">
  <img alt="ActivityCenter" src="https://github.com/user-attachments/assets/ad5b46db-2d34-4201-ab51-b778c3b3f275" width="800px">
</div>

<div align="center">
  <img alt="ActivityOverview" src="https://github.com/user-attachments/assets/1394a975-fdc7-45a1-8d33-cc7200905608" width="800px">
</div>
...
To help users get started, we provide a comprehensive tutorial that demonstrates how to use the Hypertools for uncertainty quantification and surrogate modeling of a bioelectronic implant on an anatomically realistic nerve model (Sim4Life documentation, Tutorials Section, 3.14.1 MMUX Metamodeling Pipeline Tutorial). 
