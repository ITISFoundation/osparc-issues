...
To help users get started, we provide a comprehensive tutorial (Sim4Life documentation, Tutorials Section, 3.14.1 MMUX Metamodeling Pipeline Tutorial) that demonstrates how to use the Hypertools for uncertainty quantification and surrogate modeling of a bioelectronic implant on an anatomically realistic nerve model. 
