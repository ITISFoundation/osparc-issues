...
Work together seamlessly! Multiple users can now **access and edit the same project simultaneously**.
This is especially useful if your workflow revolves around pipelines — you and your teammates can now **co-edit nodes, adjust parameters, and build workflows together in real time**.
Changes appear instantly for everyone, enabling smoother teamwork and faster iteration.
